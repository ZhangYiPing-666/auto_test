...
class RunTest(unittest.TestCase):
    ...
    def test_001(self):
        ...
        res002 = open_blue_bill(API_data_file, fuwu_api_name, fuwu_message_file, "blue_1_line", change_message)
        arrequt_respont_openbill(res002, "0000")

    # def test_002(self):
    #     """用pan开过的电票流水号--进行服务器开电票:"""
    #     change_message = {
    ...
    #     change_message["REQUEST_COMMON_FPKJ.FPQQLSH"] = get_openbill_FPQQLSH(res001)
    #     res002 = open_blue_bill(API_data_file, fuwu_api_name, fuwu_message_file, "blue_1_line", change_message)
    #     arrequt_respont_openbill(res002, "9990")
