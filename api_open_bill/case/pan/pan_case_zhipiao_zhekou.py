...
class RunTest(unittest.TestCase):
    ...
    #     }
    #     blue_res = open_blue_bill(API_data_file, api_name, message_file, "折扣_blue_1_line",change_message)
    ...
    def test_002(self):
        ...
        red_res = open_blue_bill(API_data_file, api_name, message_file, "折扣_red_1_line", change_message)
        arrequt_respont_pan_openbill(red_res, "0000")
