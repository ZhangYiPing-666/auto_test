...
#             "REQUEST_COMMON_FPKJ.YFP_HM": ""  # 原发票号码
#         }
#         blue_res = open_blue_bill(API_data_file, api_name, message_file, "blue_5_line",change_message)
#         arrequt_respont_pan_openbill(blue_res, "0000")
#         time.sleep(26)
#         blue_result = deepcopy(blue_res)
#         response_search = while_search(API_data_file, api_name, search_message, blue_result, pan)
...
#             "REQUEST_COMMON_FPKJ.YFP_HM": ""  # 原发票号码
#         }
#         blue_res = open_blue_bill(API_data_file, api_name, message_file, "blue_1_pagelist",change_message)
#         arrequt_respont_pan_openbill(blue_res, "0000")
#         time.sleep(26)
#         blue_result = deepcopy(blue_res)
#         response_search = while_search(API_data_file, api_name, search_message, blue_result, pan)
...
#             "REQUEST_COMMON_FPKJ.YFP_HM": ""  # 原发票号码
#         }
#         blue_res = open_blue_bill(API_data_file, api_name, message_file, "blue_2_pagelist",change_message)
#         arrequt_respont_pan_openbill(blue_res, "0000")
#         time.sleep(26)
#         blue_result = deepcopy(blue_res)
#         response_search = while_search(API_data_file, api_name, search_message, blue_result, pan)
