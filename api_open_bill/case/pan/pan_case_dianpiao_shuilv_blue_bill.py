...
class RunTest(unittest.TestCase):
    ...
    def test_001(self):
        ...
        change_message = {
            ...
            "REQUEST_COMMON_FPKJ.FPLXDM": "026",  # 发票类型代码:[026 增值税普票(电票),004 增值税专票(纸票),007 增值税普票(纸票),025 增值税普票(卷票)]
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "shuilv_0",change_message)
    ...
    def test_002(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "shuilv_3",change_message)
        arrequt_respont_pan_openbill(blue_res, "0000")
        blue_result = deepcopy(blue_res)
        response_search = while_search(API_data_file, api_name, search_message, blue_result, pan)
        result_search = get_respont_result(response_search)
    ...
    def test_003(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "shuilv_5",change_message)
        arrequt_respont_pan_openbill(blue_res, "0000")
        blue_result = deepcopy(blue_res)
        response_search = while_search(API_data_file, api_name, search_message, blue_result, pan)
        result_search = get_respont_result(response_search)
    ...
    def test_004(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "shuilv_6",change_message)
        arrequt_respont_pan_openbill(blue_res, "0000")
        blue_result = deepcopy(blue_res)
        response_search = while_search(API_data_file, api_name, search_message, blue_result, pan)
        result_search = get_respont_result(response_search)
    ...
    def test_005(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "shuilv_10",change_message)
        arrequt_respont_pan_openbill(blue_res, "0000")
        blue_result = deepcopy(blue_res)
        response_search = while_search(API_data_file, api_name, search_message, blue_result, pan)
        result_search = get_respont_result(response_search)
    ...
    def test_006(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "shuilv_13", change_message)
        arrequt_respont_pan_openbill(blue_res, "0000")
        blue_result = deepcopy(blue_res)
        response_search = while_search(API_data_file, api_name, search_message, blue_result, pan)
        result_search = get_respont_result(response_search)
    ...
    def test_007(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "shuilv_16", change_message)
        arrequt_respont_pan_openbill(blue_res, "0000")
        blue_result = deepcopy(blue_res)
        response_search = while_search(API_data_file, api_name, search_message, blue_result, pan)
        result_search = get_respont_result(response_search)
