...
class RunTest(unittest.TestCase):
    ...
    def test_002(self):
        ...
        blue_res = open_blue_zhi_bill(API_data_file, api_name, message_file, "blue_5_line",change_message)
        arrequt_respont_openbill(blue_res, "0000")
        print_log("蓝票开具成功\n\n")
        change_message = gengxin_red_message(blue_res, change_message)
        red_res = open_zhi_red_bill(API_data_file, api_name, blue_res["message"], change_message)
    ...
    def test_003(self):
        ...
        blue_res = open_blue_zhi_bill(API_data_file, api_name, message_file, "blue_1_pagelist",change_message)
        arrequt_respont_openbill(blue_res, "0000")
        print_log("蓝票开具成功\n\n")
        change_message = gengxin_red_message(blue_res, change_message)
        red_res = open_zhi_red_bill(API_data_file, api_name, blue_res["message"], change_message)
    ...
    def test_004(self):
        ...
        blue_res = open_blue_zhi_bill(API_data_file, api_name, message_file, "blue_3_pagelist",change_message)
        arrequt_respont_openbill(blue_res, "0000")
        print_log("蓝票开具成功\n\n")
        change_message = gengxin_red_message(blue_res, change_message)
        red_res = open_zhi_red_bill(API_data_file, api_name, blue_res["message"], change_message)
