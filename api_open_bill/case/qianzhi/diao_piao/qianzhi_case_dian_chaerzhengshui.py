...
class RunTest(unittest.TestCase):
    ...
    def test_001(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "差额征税_1_line",change_message)
    ...
    def test_002(self):
        ...
        red_res = open_blue_bill(API_data_file, api_name, message_file, "1line_差额_红票", change_message)
    ...
    def test_003(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "差额征税_免税",change_message)
        arrequt_respont_openbill(blue_res, "0000")
    ...
    def test_004(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "差额征税_不征税",change_message)
        arrequt_respont_openbill(blue_res, "0000")
