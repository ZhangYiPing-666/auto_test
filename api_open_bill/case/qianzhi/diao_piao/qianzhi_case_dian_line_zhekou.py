...
class RunTest(unittest.TestCase):
    ...
    def test_001(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "2line_折扣",change_message)
    ...
    def test_002(self):
        ...
        red_res = open_blue_bill(API_data_file, api_name, message_file, "1line_折扣_红票", change_message)
    ...
    def test_003(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "6line_折扣",change_message)
        arrequt_respont_openbill(blue_res, "0000")
    ...
    #     arrequt_respont_openbill(red_res, "9999")
    #     print_log("红票折扣开具失败，测试通过")
