...
class RunTest(unittest.TestCase):
    ...
    def test_001(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "免税_1_line",change_message)
    ...
    def test_003(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "免税_1_page",change_message)
        arrequt_respont_openbill(blue_res, "0000")
    ...
    def test_004(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "免税_LSLBZ",change_message)
        arrequt_respont_openbill(blue_res, "0000")
    ...
    def test_005(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "不征税_1_line", change_message)
        arrequt_respont_openbill(blue_res, "0000")
    ...
    def test_007(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "不征税_1_page", change_message)
        arrequt_respont_openbill(blue_res, "0000")
    ...
    def test_008(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "不征税_LSLBZ", change_message)
        arrequt_respont_openbill(blue_res, "0000")
    ...
    def test_009(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "普通零税率_1_line", change_message)
        arrequt_respont_openbill(blue_res, "0000")
    ...
    def test_011(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "普通零税率_1_page", change_message)
        arrequt_respont_openbill(blue_res, "0000")
    ...
    def test_012(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "普通零税率_LSLBZ", change_message)
        arrequt_respont_openbill(blue_res, "0000")
    ...
    def test_013(self):
        ...
        blue_res = open_blue_bill(API_data_file, api_name, message_file, "多种免税", change_message)
        arrequt_respont_openbill(blue_res, "0000")
